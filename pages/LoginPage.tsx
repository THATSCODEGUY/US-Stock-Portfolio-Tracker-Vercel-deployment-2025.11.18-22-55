...
export const LoginPage: React.FC<LoginPageProps> = ({ onShowSignup }) => {
                ...
                <div className="bg-gray-800 p-8 rounded-xl shadow-lg border border-gray-700">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                     ...
                     <p className="mt-6 text-center text-sm text-gray-400">
                        ...
                        <button onClick={onShowSignup} className="font-medium text-green-accent hover:text-green-500 focus:outline-none focus:underline transition">
                            Sign up
                        </button>
                    </p>
                </div>
