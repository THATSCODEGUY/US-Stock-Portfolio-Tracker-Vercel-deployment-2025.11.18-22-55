...
export const BanknotesIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 18.75a60.07 60.07 0 0 1 15.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 0 1 3 5.25h-.75m0 0V6a2.25 2.25 0 0 0 2.25 2.25H6a2.25 2.25 0 0 0 2.25-2.25V6m0 0h.75m-.75 0v4.5c0 .216.053.434.144.632l.75 1.5a.75.75 0 0 0 1.054.252l.362-.217a.75.75 0 0 0 .362-.632v-4.124m0 0a6.004 6.004 0 0 1 5.304-2.44m0 0c1.624 0 3.155.538 4.39 1.453m0 0L21 5.25" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 19.5v-5.25c0-.786.554-1.46 1.325-1.612l10.5-2.1c.826-.165 1.675.465 1.675 1.32v5.31c0 .653-.446 1.223-1.085 1.386l-10.5 2.688c-.73.187-1.415-.378-1.415-1.132Z" />
  </svg>
);
